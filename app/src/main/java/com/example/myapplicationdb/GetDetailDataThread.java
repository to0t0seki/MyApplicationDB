...
public class GetDetailDataThread extends Thread {
    String hallNo;
    String modelNo;
    String[] contentNo;
    Callback callback;
    ...
    GetDetailDataThread(String hallNo, String modelNo, String[] contentNo, Context context){
        this.hallNo = hallNo;
    ...
    public void run() {
        ...
        getWebData();
        //データベースから取得
        List<MainData> mainDataList = getData();
        //コールバック
        callback.callback(mainDataList);
    }
    ...
    public void setData(Map<Integer,Map<Integer,Map<String,Integer>>> map,String modelNo){
        ...
        //appDatabase.mainDataDao().insert(new MainData(402,20200514,215030003,0,0,1093,100,100));
    }
